...
/// Count occurrences of each DNA base (A, C, G, T) in a sequence column
///
/// # Platform-Specific Optimization
///
/// - **ARM (aarch64)**: Uses NEON SIMD (25× speedup)
/// - **x86_64**: Uses scalar fallback (portable)
///
/// # Evidence
///
/// Entry 020-025: NEON base counting achieves 25× speedup with Cohen's d = 5.87
///
/// # Example
///
/// ```
/// use caf::neon::count_bases;
///
/// let sequences = b"GATTACAGATTACA"; // ASCII-encoded sequences
/// let counts = count_bases(sequences);
...
/// NEON-optimized base counting (25× faster than scalar)
///
/// # Evidence
///
